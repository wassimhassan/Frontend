...
// ⚠️ Don't initialize Stripe here at the top anymore!
...
const SubscriptionForm = () => {
  ...
  // ✅ Stripe initialization using useMemo
  const stripePromise = useMemo(() => {
    const key = process.env.REACT_APP_STRIPE_PUBLIC_KEY;
    console.log("🔑 Stripe Key Loaded in Component:", key);
  ...
  return (
    <div className="subscription-form-container">
      ...
      {/* ✅ Only render Elements when Stripe is properly loaded */}
      {!isSubscriptionButtonDisabled && stripePromise && (
